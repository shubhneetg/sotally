  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <button
          type="button"
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-foreground shadow-sm hover:bg-muted transition-colors"
        >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            <label htmlFor="referral" className="block text-sm font-medium text-foreground">
